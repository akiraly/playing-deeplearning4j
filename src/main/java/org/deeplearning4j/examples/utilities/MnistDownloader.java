...
public class MnistDownloader {
  ...
  public static void download() {
    ...
    boolean exists =
        features.exists() && featuresTest.exists() && labels.exists() && labelsTest.exists();
  ...
  private static void tryDownloadingAFewTimes(URL url, File f, String targetMD5)
      throws IOException {
    tryDownloadingAFewTimes(0, url, f, targetMD5);
  }

  private static void tryDownloadingAFewTimes(int attempt, URL url, File f, String targetMD5)
      throws IOException {
    int maxTries = 3;
